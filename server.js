...
const mockEvents = {
    events: [
        { title: 'an event', id: 1, description: 'something really cool', location: 'Johns House' },
        { title: 'another event', id: 2, description: 'something even cooler', location: 'The Moon' }
    ]
};
